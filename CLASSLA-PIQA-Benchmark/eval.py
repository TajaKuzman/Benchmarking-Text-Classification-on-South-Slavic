...
def add_predictions_to_dataset(dataset_name, results):
    ...
    Args:
    - dataset_name: should be 'piqa-en', 'piqa-mk', 'piqa-bg', 'piqa-sl', 'piqa-sr_cyrl', 'piqa-hr', 'piqa-sr_latn', 'piqa-bs', 'piqa-sl-cer', 'piqa-hr-ckm'
    """
    # Load the dataset
    test_df = pd.read_json(f"datasets/{dataset_name}.jsonl", lines=True)
...
for submission_file in submission_files:
    ...
    if "submission-" in submission_file:
        ...
        with open("{}/{}".format(submission_folder,submission_file), "r") as sub_file:
            ...
            eval_lang = dataset_name.replace("piqa-", "")
...
for dataset in ['piqa-en', 'piqa-mk', 'piqa-bg', 'piqa-sl', 'piqa-sr_cyrl', 'piqa-hr', 'piqa-sr_latn', 'piqa-bs', 'piqa-sl-cer', 'piqa-hr-ckm']:
...
for lang in ["en", "sl", "hr", "bs", "bg", "hr-ckm", "mk", "sl-cer", "sr_cyrl", "sr_latn"]:
